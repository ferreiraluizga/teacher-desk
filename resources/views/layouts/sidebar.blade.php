<div class="d-none d-xxl-block">
    <aside class="d-flex flex-column text-white bg-primary flex-shrink-0 p-3 shadow-lg position-fixed"
        ...
        <a class="navbar-brand text-center" href="{{ route('index') }}" style="margin-bottom: 1vw; margin-top: 1vw;">
        ...
        <div class="dropdown-center mt-2 d-flex justify-content-center">
            ...
            <ul class="dropdown-menu dropdown-menu-dark text-small shadow" aria-labelledby="dropdownUser1">
                <li><a class="dropdown-item" href="{{ route('users.account') }}">Minha Conta</a></li>
                <li>
...
<!-- Mobile Navbar -->
<nav class="navbar p-3 d-block d-xxl-none navbar-dark bg-primary shadow-lg fixed-top">
...
<!-- Mobile Offcanvas -->
<div class="offcanvas offcanvas-end text-bg-primary" tabindex="-1" id="mobileMenu" aria-labelledby="mobileMenuLabel">
